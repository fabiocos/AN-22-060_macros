...
{ 
  ...
  TString canvName = "pion_endcap_efficiency";
...

  {
    ...
    TH1F *data1 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDPiAsPiEff")->Clone());
    TH1F *data2 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDPiAsKEff")->Clone());
    TH1F *data3 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDPiAsPEff")->Clone());
    TH1F *data4 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDPiNoPIDEff")->Clone());
