...
{ 
  ...
  TString canvName = "kaon_endcap_efficiency";
...

  {
    ...
    TH1F *data1 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDKAsPiEff")->Clone());
    TH1F *data2 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDKAsKEff")->Clone());
    TH1F *data3 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDKAsPEff")->Clone());
    TH1F *data4 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDKNoPIDEff")->Clone());
    ...
    latex.DrawLatexNDC(.67,.68,"K PID, 1.6 < |#eta| < 3");
