...
{ 
  ...
  TString canvName = "btl_nopid_type";
...

  {
    ...
    TH1F *data = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelNoPIDtype")->Clone());
    data->SetDirectory(0);
    ...
    data->GetXaxis()->SetTitle("PID type");  
