...
{ 
  ...
  TString canvName = "MVA_ptmatch_efficiency";
...

  {
    ...
    TH1F *data = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/MVAPtMatchEff")->Clone());
    data->SetDirectory(0);
