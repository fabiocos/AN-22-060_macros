...
{ 
  ...
  TString canvName = "proton_endcap_efficiency";
...

  {
    ...
    TH1F *data1 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDPAsPiEff")->Clone());
    TH1F *data2 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDPAsKEff")->Clone());
    TH1F *data3 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDPAsPEff")->Clone());
    TH1F *data4 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/EndcapPIDPNoPIDEff")->Clone());
    ...
    latex.DrawLatexNDC(.27,.58,"p PID, 1.6 < |#eta| < 3");
