...
{ 
  ...
  TString canvName = "barrel_purity";
...

  {
    ...
    TH1F *data1 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPiPurity")->Clone());
    TH1F *data2 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelKPurity")->Clone());
    TH1F *data3 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPPurity")->Clone());
    ...
    latex.DrawLatexNDC(.17,.38,"|#eta| < 1.5");
