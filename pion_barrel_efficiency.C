...
{ 
  ...
  TString canvName = "pion_barrel_efficiency";
...

  {
    ...
    TH1F *data1 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPIDPiAsPiEff")->Clone());
    TH1F *data2 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPIDPiAsKEff")->Clone());
    TH1F *data3 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPIDPiAsPEff")->Clone());
    TH1F *data4 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPIDPiNoPIDEff")->Clone());
    ...
    latex.DrawLatexNDC(.67,.73,"#pi PID, |#eta| < 1.5");
