...
{ 
  ...
  TString canvName = "proton_barrel_efficiency";
...

  {
    ...
    TH1F *data1 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPIDPAsPiEff")->Clone());
    TH1F *data2 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPIDPAsKEff")->Clone());
    TH1F *data3 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPIDPAsPEff")->Clone());
    TH1F *data4 = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/BarrelPIDPNoPIDEff")->Clone());
    ...
    TLegend *leg1 = new TLegend(.65,.70,.85,.85);
    leg1->SetTextFont(82);
    ...
    latex.DrawLatexNDC(.67,.88,"p PID, |#eta| < 1.5");
