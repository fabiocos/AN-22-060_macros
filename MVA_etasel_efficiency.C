...
{ 
  ...
  TString canvName = "MVA_etasel_efficiency";
...

  {
    ...
    TH1F *data = static_cast<TH1F*>(file_.Get("DQMData/Run 1/MTD/Run summary/Vertices/MVAEtaSelEff")->Clone());
